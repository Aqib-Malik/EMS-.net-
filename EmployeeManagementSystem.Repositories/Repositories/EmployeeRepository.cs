...
namespace EmployeeManagementSystem.Repositories
{
    public class EmployeeRepository
    {
        ...
        {
            new Employee { Id = 1, Name = "aqib", DateOfBirth = Convert.ToDateTime("1996-07-14"), Email = "aqib@gmail.com", DateOfJoining = DateTime.Today, Competency = "C2", Department = "IT" },
            new Employee { Id = 2, Name = "qasim", DateOfBirth = Convert.ToDateTime("1957-01-07"), Email = "qasim@gmail.com", DateOfJoining = DateTime.Today, Competency = "C7", Department = "Human Resources" },
            new Employee { Id = 3, Name = "sfs", DateOfBirth = Convert.ToDateTime("1923-12-23"), Email = "dsf@gmail.com", DateOfJoining = DateTime.Today, Competency = "C4", Department = "Accounting and Finance" },
            new Employee { Id = 4, Name = "dgsrdg", DateOfBirth = Convert.ToDateTime("1890-03-12"), Email = "gtrr@rediff.com", DateOfJoining = DateTime.Today, Competency = "C1", Department = "Testing" },
            new Employee { Id = 5, Name = "dsgfhs", DateOfBirth = Convert.ToDateTime("1965-10-29"), Email = "qwer@gmail.com", DateOfJoining = DateTime.Today, Competency = "C2", Department = "Human Resources" }
        };
